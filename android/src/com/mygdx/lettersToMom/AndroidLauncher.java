...
import com.mygdx.lettersToMom.SaveData.SaveDatabase;
import com.mygdx.lettersToMom.SaveData.SaveEntry;
...
public class AndroidLauncher extends AndroidApplication {
	...
	*/
	...
	//The app
	com.mygdx.lettersToMom.main.lettersToMom lettersToMom = new lettersToMom();
	...
	protected void onCreate (Bundle savedInstanceState) {
		...
		initialize(lettersToMom, config);										//Starts the game
